...
<div class="announcement-list">
  <div class="announcement-item">
    <div class="announcement-header">
      ...
      <span class="announcement-date">11.09.2026</span>
    </div>
    <div class="announcement-text">Çalışma Hayatı ve Sosyal Politika Araştırmaları Derneğimizin kuruluş işlemleri tamamlanmıştır.</div>
  </div>

  <div class="announcement-item announcement-item-older">
    <div class="announcement-header">
      <span class="announcement-date">Duyuru</span>
    </div>
    <div class="announcement-text">Etkinlik, yayın ve proje duyuruları bu alanda yer alacaktır.</div>
  </div>
</div>
